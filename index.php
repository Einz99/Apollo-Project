...
<html lang="en">
  <head>
    ...
    <title>Apollo+ Entertainment</title>
  ...
  <body>
    ...
    <section class="home">
      <video
        ...
        src="assets/homeAssets/Apollo+.mp4"
        autoplay
        muted
        loop
      ></video>
      <video
        class="video-slide"
        src="assets/homeAssets/sarah g.mp4"
        autoplay
        muted
        loop
      ></video>
      <video
        class="video-slide"
        src="assets/homeAssets/BINI.mp4"
        autoplay
        muted
        loop
      ></video>
      <video
        class="video-slide"
        src="assets/homeAssets/cup of joe.mp4"
        autoplay
        muted
        loop
      ></video>
      <video
        class="video-slide"
        src="assets/homeAssets/SB19.mp4"
        autoplay
        muted
        loop
      ></video>
      ...
      <div class="content">
        <h1>LEADER IN<br /><span>ENTERTAINMENT</span></h1>
        <p>
